...
namespace ECommerce.Infrastructure.Localization;

public static class LocalizationServiceCollectionExtensions
{
    public static IServiceCollection AddECommerceLocalization(this IServiceCollection services, LocalizationProviders providers = null)
    {
