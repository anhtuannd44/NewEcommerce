...
public class Startup
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        services.AddPersistence(AppSettings.ConnectionStrings.ECommerce)
                .AddDomainServices()
        ...
        .AddServer(options =>
        {
            ...
            options.RegisterScopes(Scopes.OpenId, Scopes.Profile, Scopes.OfflineAccess, "ECommerce.WebAPI");
