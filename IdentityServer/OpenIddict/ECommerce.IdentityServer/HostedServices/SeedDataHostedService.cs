    ...
    public async Task StartAsync(CancellationToken cancellationToken)
    {
        ...
        await UpsertClientApplication(manager, new OpenIddictApplicationDescriptor
        {
            ...
            Permissions =
            {
                ...
                OpenIddictConstants.Permissions.Prefixes.Scope + "ECommerce.WebAPI",
        ...
        await UpsertClientApplication(manager, new OpenIddictApplicationDescriptor
        {
            ClientId = "ECommerce.WebMVC",
            ClientSecret = "secret",
            DisplayName = "ECommerce Web MVC",
            RedirectUris =
            {
        ...
        await UpsertClientApplication(manager, new OpenIddictApplicationDescriptor
        {
            ClientId = "ECommerce.BlazorServerSide",
            ClientSecret = "secret",
            DisplayName = "ECommerce BlazorServerSide",
            RedirectUris =
            {
        ...
        await UpsertClientApplication(manager, new OpenIddictApplicationDescriptor
        {
            ClientId = "ECommerce.BlazorWebAssembly",
            DisplayName = "ECommerce BlazorWebAssembly",
            RedirectUris =
            {
        ...
        await UpsertClientApplication(manager, new OpenIddictApplicationDescriptor
        {
            ClientId = "ECommerce.React",
            DisplayName = "ECommerce React",
            RedirectUris =
            {
        ...
        await UpsertClientApplication(manager, new OpenIddictApplicationDescriptor
        {
            ClientId = "ECommerce.Vue",
            DisplayName = "ECommerce Vue",
            RedirectUris =
            {
