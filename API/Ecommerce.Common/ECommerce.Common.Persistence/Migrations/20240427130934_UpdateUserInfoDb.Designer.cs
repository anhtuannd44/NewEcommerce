...
namespace ECommerce.Common.Persistence.Migrations
{
    ...
    [Migration("20240427130934_UpdateUserInfoDb")]
    partial class UpdateUserInfoDb
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ECommerce.Common.Domain.Entities.Orders.OrderAttributeMapping", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.ToTable("OrderAttributeMapping", (string)null);
                });
            ...
            modelBuilder.Entity("ECommerce.Common.Domain.Entities.Orders.OrderAttributeMapping", b =>
                {
                    b.HasOne("ECommerce.Common.Domain.Entities.Orders.OrderAttribute", "OrderAttribute")
                        .WithMany("OrdersAttributeMappings")
                        .HasForeignKey("OrderAttributeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ECommerce.Common.Domain.Entities.Orders.Order", "Order")
                        .WithMany("OrderAttributeMappings")
            ...
            modelBuilder.Entity("ECommerce.Common.Domain.Entities.Orders.Order", b =>
                {
                    b.Navigation("OrderAttributeMappings");
            ...
            modelBuilder.Entity("ECommerce.Common.Domain.Entities.Orders.OrderAttribute", b =>
                {
                    b.Navigation("OrdersAttributeMappings");
                });
