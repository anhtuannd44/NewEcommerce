...
using System.Text;
using ECommerce.Common.CrossCuttingConcerns.Storages.Local;
using Microsoft.AspNetCore.Hosting;
using Microsoft.Extensions.FileProviders;

namespace ECommerce.Common.Infrastructure.Files;

/// <summary>
/// IO functions using the on-disk file system
/// </summary>
public class ECommerceFileProvider : PhysicalFileProvider, IECommerceFileProvider
{
    /// <summary>
    /// Initializes a new instance of a ECommerceFileProvider
    /// </summary>
    /// <param name="webHostEnvironment">Hosting environment</param>
    public ECommerceFileProvider(IWebHostEnvironment webHostEnvironment)
        : base((File.Exists(webHostEnvironment.ContentRootPath) ? Path.GetDirectoryName(webHostEnvironment.ContentRootPath) : webHostEnvironment.ContentRootPath) ?? string.Empty)
    {
    ...
    public virtual string MapPath(string path)
    {
        ...
        return Combine(Root, path) + pathEnd;
    }
