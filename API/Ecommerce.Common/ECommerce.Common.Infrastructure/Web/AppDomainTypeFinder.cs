...
using ECommerce.Common.CrossCuttingConcerns.Web;
using ECommerce.Common.Infrastructure.Common;

namespace ECommerce.Common.Infrastructure.Web;
...
public partial class AppDomainTypeFinder : ITypeFinder
{
    ...
    protected IECommerceFileProvider _fileProvider;

    #endregion

    #region Ctor

    public AppDomainTypeFinder(IECommerceFileProvider fileProvider = null)
    {
