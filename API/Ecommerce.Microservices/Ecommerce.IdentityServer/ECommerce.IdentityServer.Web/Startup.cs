...
using ECommerce.IdentityServer.Application;
...
public class Startup
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        services.AddSwaggerGen(c =>
        {
            c.TagActionsBy(x =>
            {
                ...
                var tagNameAttribute = (SwaggerTagNameAttribute)actionDescriptor.ControllerTypeInfo.GetCustomAttributes(typeof(SwaggerTagNameAttribute), false).FirstOrDefault();
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
    {
        ...
        app.UseCors(x => x.AllowAnyOrigin()
            ...
            .AllowAnyHeader().WithExposedHeaders("X-Filename", "Session-Expired")
        );
        app.UseRouting();
