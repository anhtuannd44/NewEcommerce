...
using ECommerce.Common.Application.Services.Common;
...
using ECommerce.Shop.Domain.IService.Catalog;
using Microsoft.AspNetCore.Http;
using Microsoft.EntityFrameworkCore;
using Microsoft.Extensions.Primitives;

namespace ECommerce.Shop.Application.Services.Catalog;

/// <summary>
/// Product attribute parser
/// </summary>
public class ProductAttributeParserService : BaseAttributeParser, IProductAttributeParser
{
    protected readonly IUnitOfWork _unitOfWork;
    protected readonly ILogger<BlogService> _logger;

    public ProductAttributeParserService(IUnitOfWork unitOfWork,
                ...
                if (formKey.Equals($"addtocart_{product.Id}.CustomerEnteredPrice", StringComparison.InvariantCultureIgnoreCase))
                {
                    if (decimal.TryParse(form[formKey], out var customerEnteredPrice))
                        customerEnteredPriceConverted =
                            await _currencyService.ConvertToPrimaryStoreCurrencyAsync(customerEnteredPrice, await _workContext.GetWorkingCurrencyAsync());
                    break;
                }
            }
