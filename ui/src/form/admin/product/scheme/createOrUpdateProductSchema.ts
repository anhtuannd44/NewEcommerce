...
import { IProductFile } from '../interface/IProductFile'
import { IProductAttribute } from '../interface/IProductAttribute'
import { IAttributeJson, IProductAttributeCombination } from '../interface/IProductCombination'
...
export const productAttributeCombinationSchema = Yup.object<IProductAttributeCombination>().shape({
  ...
  attributeJson: Yup.array().required().of(
